...
// 311b40fd5a854018b2844569de4ca0a0
...
useEffect(()=>{if(location.state && location.state.user){
  ...
  const sideNav = [{name: "NEWS",route:"/",icon: <NewspaperIcon/>},{name: "Headlines",route:"/headlines",icon: <NewspaperIcon/>},{name: "One News",route:"/onenews",icon: <ArticleIcon/>}]
